...
const initialReports: PatrolReport[] = [
  {
    ...
    issues: 3,
    status: '已完成',
    summary: '专项检查高标准农田6块，发现撂荒问题2处、非粮化问题1处',
  },
  {
    id: 'XC-2026-002',
    date: '2026-06-19',
    ...
    issues: 1,
    status: '已完成',
    summary: '抽查地块4块，发现1处疑似撂荒地块约3.2亩，已通知村委会限期整改',
  },
  {
    id: 'XC-2026-003',
    date: '2026-06-18',
  ...
  },
  {
    ...
    issues: 2,
    status: '已完成',
    summary: '专项检查高标准农田5块，发现灌溉设施损坏1处、非粮化问题1处',
  },
  {
    id: 'XC-2026-005',
    date: '2026-06-16',
    ...
    issues: 0,
    status: '进行中',
    summary: '抽查地块3块，目前种植情况正常，巡查仍在进行中',
  },
  {
    id: 'XC-2026-006',
    date: '2026-06-15',
    ...
    issues: 1,
    status: '已完成',
    summary: '抽查地块4块，发现1处耕地边界标识不清，已要求重新确认',
  },
  {
    id: 'XC-2026-007',
    date: '2026-06-14',
    ...
    issues: 2,
    status: '待审核',
    summary: '抽查地块5块，发现疑似撂荒问题1处、割青问题1处，报告待审核',
  },
  {
    id: 'XC-2026-008',
    date: '2026-06-13',
  ...
  },
  {
    ...
    issues: 1,
    status: '进行中',
    summary: '抽查地块4块，发现1处疑似非粮化种植，正在进一步核实',
  },
  {
    id: 'XC-2026-011',
    date: '2026-06-10',
  ...
  },
  {
    ...
    issues: 1,
    status: '已完成',
    summary: '抽查地块4块，发现1处耕地存在违规取土现象，已下达整改通知',
  },
  {
    id: 'XC-2026-015',
    date: '2026-06-07',
  ...
  },
  {
    ...
    issues: 1,
    status: '待审核',
    summary: '抽查地块4块，发现1处疑似撂荒约2.5亩，报告待审核',
  },
  {
    id: 'XC-2026-021',
    date: '2026-06-01',
  ...
  },
  {
    ...
    issues: 2,
    status: '已完成',
    summary: '专项检查5块，发现灌溉渠道堵塞1处、撂荒问题1处',
  },
  {
    id: 'XC-2026-023',
    date: '2026-05-25',
  ...
  },
  {
    ...
    issues: 0,
    status: '进行中',
    summary: '抽查地块2块，目前未发现问题，巡查仍在进行中',
  },
  {
    id: 'XC-2026-025',
    date: '2026-05-20',
    ...
    issues: 2,
    status: '已完成',
    summary: '专项检查5块，发现非粮化问题1处、耕地质量下降1处',
  },
  {
    id: 'XC-2026-026',
    date: '2026-05-18',
    ...
    issues: 1,
    status: '已完成',
    summary: '抽查地块3块，发现1处耕地存在违规搭建，已要求拆除',
  },
  {
    id: 'XC-2026-027',
    date: '2026-05-15',
    ...
    issues: 0,
    status: '已完成',
    summary: '抽查地块4块，小麦收割后复种情况良好，未发现问题',
  },
  {
    id: 'XC-2026-028',
    date: '2026-05-12',
    ...
    issues: 1,
    status: '待审核',
    summary: '抽查地块3块，发现1处疑似耕地占用，报告待审核',
  },
  {
    id: 'XC-2026-029',
    date: '2026-05-10',
    ...
    issues: 2,
    status: '已完成',
    summary: '专项检查4块，发现撂荒问题1处、非粮化问题1处，已下达整改通知',
  },
  {
    id: 'XC-2026-030',
    date: '2026-06-20',
    ...
    issues: 2,
    status: '已完成',
    summary: '专项检查高标准农田5块，发现撂荒问题1处、非粮化问题1处',
  },
  {
    id: 'XC-2026-031',
    date: '2026-06-18',
    ...
    issues: 1,
    status: '已完成',
    summary: '抽查地块4块，发现1处疑似撂荒地块约4.5亩，已通知村委会限期整改',
  },
  {
    id: 'XC-2026-032',
    date: '2026-06-16',
  ...
  },
  {
    ...
    issues: 3,
    status: '已完成',
    summary: '专项检查高标准农田6块，发现灌溉设施损坏1处、撂荒问题2处',
  },
  {
    id: 'XC-2026-034',
    date: '2026-06-12',
    ...
    issues: 0,
    status: '进行中',
    summary: '抽查地块4块，目前种植情况正常，巡查仍在进行中',
  },
  {
    id: 'XC-2026-035',
    date: '2026-06-10',
    ...
    issues: 1,
    status: '已完成',
    summary: '抽查地块3块，发现1处耕地边界标识不清，已要求重新确认',
  },
  {
    id: 'XC-2026-036',
    date: '2026-06-09',
    ...
    issues: 2,
    status: '待审核',
    summary: '抽查地块5块，发现疑似撂荒问题1处、非粮化问题1处，报告待审核',
  },
  {
    id: 'XC-2026-037',
    date: '2026-06-08',
    ...
    issues: 2,
    status: '已完成',
    summary: '专项检查5块，发现灌溉渠道堵塞1处、非粮化问题1处',
  },
  {
    id: 'XC-2026-038',
    date: '2026-06-07',
